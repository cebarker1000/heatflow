...
def run_simulation(cfg, mesh_folder, rebuild_mesh=False, visualize_mesh=False, output_folder=None, watcher_points=None, write_xdmf=True):
    """
    ...
    if rebuild_mesh:
        ...
        mat_tag_map = mesh_cfg['material_tags']
...
if __name__ == '__main__':
    ...
    # Run the simulation
    run_simulation(cfg, args.mesh_folder, args.rebuild_mesh, args.visualize_mesh, args.output_folder, args.watcher_points, args.write_xdmf)
